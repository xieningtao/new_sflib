...
abstract public class SFBaseChatFragment extends BaseFragment {
    ...
    private void init(View view) {
        mSmileIv = view.findViewById(R.id.edit_smile);
        mGuider = view.findViewById(R.id.guider);
        mExpressionContainer = view.findViewById(R.id.expression_container);
        mInputEt = view.findViewById(R.id.input_et);
        mVoice = view.findViewById(R.id.edit_voice);
        mVoiceInput = view.findViewById(R.id.input_voice_bt);
...
//                        MediaRecordManager.getInstance().start();
                        ...
                        EventBus.getDefault().post(new SFChatEvent(SFChatEvent.VOICE_BUTTON_PRESS));
                    } catch (Exception e) {
...
//                    MediaRecordManager.getInstance().stop();
                    ...
                    EventBus.getDefault().post(new SFChatEvent(SFChatEvent.VOICE_BUTTON_UP));
                } else {//move
