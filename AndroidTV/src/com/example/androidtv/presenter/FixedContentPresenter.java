...
/**
 * Created by xieningtao on 15-12-25.
 */
public class FixedContentPresenter extends Presenter {
    ...
    public FixedContentPresenter(Activity activity, int verticalExtraSpace, int horizontalExtraSpace) {
