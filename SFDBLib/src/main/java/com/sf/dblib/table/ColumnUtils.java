...
import com.sf.dblib.annotation.*;
...
public class ColumnUtils {
    ...
    private static final String TAG=ColumnUtils.class.getName();
    ...
    public static Method getColumnGetMethod(Class<?> entityType, Field field) {
        ...
        if (getMethod == null) {
            ...
            try {
                ...
                L.debug(TAG,methodName + " not exist");
            }
        }
    ...
    public static Class<?> getForeignEntityType(com.sf.dblib.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.sf.dblib.table.Finder finderColumn) {
