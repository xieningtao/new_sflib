...
import com.sf.dblib.annotation.Id;
...
public class TableUtils {
    private static final String TAG=TableUtils.class.getName();
    private TableUtils() {
    }
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.sf.dblib.table.Id> entityIdMap = new ConcurrentHashMap<String, com.sf.dblib.table.Id>();

    /* package */
    static synchronized com.sf.dblib.table.Id getId(Class<?> entityType) {
        ...
        com.sf.dblib.table.Id id = new com.sf.dblib.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.sf.dblib.table.Id id = getId(entityType);
