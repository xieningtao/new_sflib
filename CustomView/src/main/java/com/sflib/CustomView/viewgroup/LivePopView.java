...
public class LivePopView extends ViewGroup {
    ...
    private void initTransition() {
        ...
        @SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder pvhTop = PropertyValuesHolder.ofInt("top", 40, 10);
        @SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder pvhBottom = PropertyValuesHolder.ofInt("bottom", 30, 100);
