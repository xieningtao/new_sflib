 ...
 */
package com.sflib.CustomView.wheel;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    /** Default text color */
    public static final int DEFAULT_TEXT_COLOR = 0xFFCBCBCB;
    ...
    private TextView getTextView(View view, int textResource) {
        ...
        try {
           ...
           L.error(this, "You must supply a resource ID for a TextView");
    ...
    public void setTextColor(View view, boolean current) {
        int color = current ? LABEL_COLOR : DEFAULT_TEXT_COLOR;
