...
import com.basesmartframe.baseadapter.newmultiadapter.BaseSingleChoicesAdapter;
 ...
 */
public class ActivitySingleChoice extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChoice.setAdapter(new MySingleAdapter(new MyBaseAdpater(),R.id.choice_iv));
    }

    class MySingleAdapter extends BaseSingleChoicesAdapter {

        public MySingleAdapter(BaseAdapter baseAdapter, int checkId) {
    ...
    class MyBaseAdpater extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(ActivitySingleChoice.this).inflate(R.layout.choice_item, null);
            }
