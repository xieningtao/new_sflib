...
import com.basesmartframe.gesture.SlidingLeftViewLayout;
...
public class GesturePullListFragment extends BasePullListFragment<Student> {
    ...
    private SlidingLeftViewLayout mViewLayout;
...
//}
    ...
    protected void bindView(BaseAdapterHelper help, int position, Student bean) {
        ...
        SlidingLeftViewLayout viewLayout=help.getView(R.id.sliding_fl);
        viewLayout.setExtraView(help.getView(R.id.extra_container_ll));
        help.getView(R.id.b1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SFToast.showToast("click b1");
            }
        });
        help.getView(R.id.b2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SFToast.showToast("click b2");
            }
        });
    }
