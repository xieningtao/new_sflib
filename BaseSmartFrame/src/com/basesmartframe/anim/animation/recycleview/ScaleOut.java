...
public class ScaleOut extends SegmentAnimator {
    ...
    public void startAnimation(final ViewHolder holder, long duration, final BaseItemAnimator animator) {
        ...
        ViewCompat.animate(holder.itemView).scaleX(0f).scaleY(0f).setDuration(duration).setStartDelay(mDelayCount * mDelay).setListener(new BaseItemAnimator.VpaListenerAdapter() {
            @Override
