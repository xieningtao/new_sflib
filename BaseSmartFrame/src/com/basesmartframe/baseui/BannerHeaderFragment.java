...
import com.basesmartframe.baseview.ScrollViewPager;
import com.basesmartframe.baseview.ScrollViewPager.BannerPagerAdapter;
import com.basesmartframe.baseview.autoviewpager.AutoScrollViewPager;
import com.basesmartframe.baseview.indicator.CirclePageIndicator;
...
public abstract class BannerHeaderFragment<T extends BannerHeaderFragment.BannerUrlAction>
	...
	private void init(View view) {
		mData.clear();
		mViewPager = (AutoScrollViewPager) view.findViewById(R.id.scroll_pager);
		mPageIndicator = (CirclePageIndicator) view
	...
	public void onEvent(List<T> data) {
