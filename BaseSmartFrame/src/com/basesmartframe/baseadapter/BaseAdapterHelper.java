...
public class BaseAdapterHelper {
	...
	private BaseAdapterHelper(View convertView, int position) {
	...
	static public BaseAdapterHelper get(View convertView, int position) {
		if (convertView == null)
			return null;
		if (null == convertView.getTag()) {
			return new BaseAdapterHelper(convertView, position);
		}
	...
	/**
	 * 通过imageLoader来展示图片，如果想要获取更多对图片的操作，请参考{@link #setImageBuilder}
	 * 
	 * @param viewId
	 *            The view id.
	 * @param imageUrl
