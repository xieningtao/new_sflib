...
public class VideoViewHolder {
    ...
    public VideoViewHolder(View view) {
        ...
        zoom_iv = view.findViewById(R.id.zoomout_iv);
        pause_iv = view.findViewById(R.id.pause_iv);
        seekBar = view.findViewById(R.id.video_progress);
        ...
        reload_bt = view.findViewById(R.id.reload_bt);
        black_view = view.findViewById(R.id.black_view);

        //video view
        mVideoView = view.findViewById(R.id.video_view);

        videoshow_cover = view.findViewById(R.id.videoshow_cover);
        fast_control_tv = view.findViewById(R.id.fast_control_tv);

        mBackView=view.findViewById(R.id.videoshow_pt_back);
        mCover= view.findViewById(R.id.videoshow_cover);
