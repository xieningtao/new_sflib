    ...
    public static class Builder {
        ...
        public AsyncExecutor buildForScope(Object executionContext) {
            ...
            if (failureEventType == null) {
                failureEventType = de.greenrobot.event.util.ThrowableFailureEvent.class;
            }
        ...
        threadPool.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (event instanceof de.greenrobot.event.util.HasExecutionScope) {
                        ((de.greenrobot.event.util.HasExecutionScope) event).setExecutionScope(scope);
                    }
                    eventBus.post(event);
                }
            }
